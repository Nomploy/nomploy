...
export const NomployBackupEmail = ({
	type = "success",
	errorMessage,
	date = "2023-05-01T00:00:00.000Z",
	backupSize,
}: TemplateProps) => {
	const previewText = `Nomploy instance backup was ${type === "success" ? "successful ✅" : "failed ❌"}`;
			...
			>
				...
				<Body className="bg-white my-auto mx-auto font-sans px-2">
					<Container className="border border-solid border-[#eaeaea] rounded-lg my-[40px] mx-auto p-[20px] max-w-[465px]">
						...
						<Text className="text-black text-[14px] leading-[24px]">
							Your Nomploy instance backup was{" "}
							{type === "success"
								? "successful ✅"
						...
						<Section className="flex text-black text-[14px] leading-[24px] bg-[#F4F4F5] rounded-lg p-2">
							...
							<Text className="!leading-3">
								Backup Type: <strong>Complete Nomploy Instance</strong>
							</Text>
							<Text className="!leading-3">
								Content: <strong>/etc/nomploy + PostgreSQL Database</strong>
							</Text>
							{backupSize && (
								<Text className="!leading-3">
...
export default NomployBackupEmail;
