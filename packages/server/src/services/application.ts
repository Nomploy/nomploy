import { docker } from "@nomploy/server/constants";
...
import { buildRemoteDocker } from "@nomploy/server/utils/providers/docker";
import {
	cloneGitRepository,
	getGitCommitInfo,
...
import { createTraefikConfig } from "@nomploy/server/utils/traefik/application";
...
export const deployApplication = async ({
	...
	const buildLink = `${await getNomployUrl()}/dashboard/project/${application.environment.projectId}/environment/${application.environmentId}/services/application/${application.applicationId}?tab=deployments`;
...
export const deployPreviewApplication = async ({
	...
	try {
		...
		application.env = `${application.previewEnv}\nNOMPLOY_DEPLOY_URL=${previewDeployment?.domain?.host}`;
